...
export const INSURANCE: InsurancePolicy[] = [
  {
    ...
    premiumEmployer: '100% for self & family', ic: 'health',
  },
  {
  ...
  },
  {
    ...
    premiumEmployer: '100%', ic: 'holiday',
  },
  {
    ...
    premiumEmployer: '100%', ic: 'health',
  },
];

export const PERKS: { n: string; d: string; ic: IconName }[] = [
  { n: 'Annual health check-up', d: 'Fully paid, for employee and spouse', ic: 'health' },
  { n: 'Employee assistance programme', d: '24×7 confidential counselling, 8 free sessions a year', ic: 'idea' },
  { n: 'Learning wallet', d: '₹40,000 per year for courses, books and conferences', ic: 'learning' },
  { n: 'Work-from-home setup', d: 'One-time ₹25,000 for chair, desk and monitor', ic: 'assets' },
  { n: 'Internet reimbursement', d: '₹1,500 per month against a bill', ic: 'globe' },
  { n: 'Referral bonus', d: '₹40,000 (₹75,000 for L3 and above) after 90 days', ic: 'money' },
  { n: 'Creche & childcare support', d: '₹8,000 per month per child under 6', ic: 'gift' },
  { n: 'Sabbatical', d: 'Up to 3 months unpaid after 5 years of service', ic: 'holiday' },
];
...
export const FBP_COMPONENTS: FbpComponent[] = [
  { id: 'fuel', n: 'Fuel & Vehicle Maintenance', cap: 28800, note: 'Tax-free against bills, ₹2,400 per month', ic: 'travel' },
  { id: 'meal', n: 'Meal Card', cap: 26400, note: '₹50 per meal, 2 meals × 22 days — fully tax-free', ic: 'meal' },
  { id: 'telecom', n: 'Telephone & Internet', cap: 24000, note: 'Tax-free against bills', ic: 'phone' },
  { id: 'books', n: 'Books & Periodicals', cap: 12000, note: 'Tax-free against bills', ic: 'learning' },
  { id: 'lta', n: 'Leave Travel Allowance', cap: 60000, note: 'Exempt twice in a block of 4 years', ic: 'travel' },
  { id: 'prof', n: 'Professional Development', cap: 40000, note: 'Courses, certifications, conferences', ic: 'target' },
];
