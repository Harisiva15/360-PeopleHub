...
export const RETENTION: RetentionRow[] = [
  ...
  { k: 'Attendance and location', d: 'Punch times, work mode, late marks, and the coordinates at punch compared against the site geo-fence', law: 'Legitimate interest', keep: '24 months', basis: 'Payroll accuracy and dispute resolution' },
